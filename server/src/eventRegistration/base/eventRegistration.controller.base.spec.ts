...
describe("EventRegistration", () => {
  ...
  test("POST /eventRegistrations", async () => {
  ...
  test("GET /eventRegistrations", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /eventRegistrations/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/eventRegistrations"}/${nonExistingId}`)
  ...
  test("GET /eventRegistrations/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/eventRegistrations"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /eventRegistrations existing resource", async () => {
